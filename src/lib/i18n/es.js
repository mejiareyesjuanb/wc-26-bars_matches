...
export default {
  ...
  picker: {
    compactPrompt: 'Elige barrios para enfocar la lista — o déjalo vacío para ver toda la ciudad.',
    title: 'Elige tus barrios',
    blurb: 'Elige los barrios que quieras para enfocar la lista — o déjalo vacío para ver toda la ciudad.',
    see: 'Ver bares',
    seeAll: 'Ver todos los bares',
