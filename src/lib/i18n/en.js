...
export default {
  ...
  picker: {
    compactPrompt: 'Pick neighborhoods to focus the list — or leave empty for the whole city.',
    title: 'Choose your neighborhoods',
    blurb: 'Pick any neighborhoods to focus the list — or leave empty to see the whole city.',
    see: 'See bars',
    seeAll: 'Show all bars',
