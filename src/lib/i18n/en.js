...
export default {
  ...
  detail: {
    ...
    noVenuesArea: 'No sports bars or confirmed World Cup venues in your areas yet.',
    barsNote: 'Bars showing the World Cup in your areas — not specific to this match.',
  ...
  bars: {
    ...
    emptyAll: 'No sports bars or confirmed World Cup venues in your areas.',
    showMore: 'Show more ({n} more)',
    changeAreas: '{h} — change areas',
  },
